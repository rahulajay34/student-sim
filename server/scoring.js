...
export const DEFAULT_SCORING_CONFIG = {
  ...
  phaseExpectations: {
    1: "Opening. Good now: warm greeting, audibility/camera check, a short self-introduction, congratulating the student, light agenda-setting. Listening and building rapport is the expected default and scores 0. Hard-pitching this early reads as weak.",
    2: "Discovery. This is where the student ANSWERS the counsellor's questions. Good now: short, genuine questions about background, current work/study, goals, why they applied, whether parents know. Letting the student talk is the expected default and scores 0. Lecturing instead of probing is weak.",
    3: "Presentation. The counsellor is explaining the programme while the student mostly LISTENS and gives short acknowledgements. Plain, clear explaining is the EXPECTED DEFAULT here and scores 0. Good: specifics tied to what THIS student said. Weak: 100+ word brochure dumps with no link to the student.",
