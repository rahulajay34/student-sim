// _shared/lib/realtime.js — ported from server/realtime.js.
// CHANGES:
//   - process.env.* replaced with getEnv() from ../env.js.
//   - Import paths updated to local ./promptConfig.js, ./prompt.js, etc.
//   - getPromptConfig() usage kept as legacy alias (calls loadPromptConfig(null)).
...
export const OPENAI_DEFAULT_VOICE_FEMALE = getEnv("OPENAI_REALTIME_VOICE") || "marin";
export const OPENAI_DEFAULT_VOICE_MALE = getEnv("OPENAI_REALTIME_VOICE_MALE") || "cedar";
export const OPENAI_DEFAULT_VOICE = "auto";
export const OPENAI_REALTIME_MODEL = getEnv("OPENAI_REALTIME_MODEL") || "gpt-realtime";
...
export async function mintOpenAIClientSecret({ instructions, voice, model } = {}) {
  ...
  const session = {
    ...
    audio: {
      input: {
        transcription: { model: getEnv("OPENAI_TRANSCRIBE_MODEL") || "gpt-4o-mini-transcribe" },
        turn_detection: {
          type: "semantic_vad",
          eagerness: getEnv("OPENAI_VAD_EAGERNESS") || "auto",
        },
      },
